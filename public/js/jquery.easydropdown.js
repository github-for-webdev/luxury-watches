  ...
  EasyDropDown.prototype = {
    ...
    render: function () {
      ...
      self.$container = self.$select
        ...
        .parent();
      self.$active = $(
        '<span class="selected">' + self.selected.title + "</span>"
    ...
    bindHandlers: function () {
          ...
          if (self.inFocus) {
            ...
            if (key == 38 || key == 40 || key == 32) {
              ...
              if (key == 38) {
                ...
                self.focusIndex++;
                self.focusIndex =
                  self.focusIndex > self.$items.length - 1
                    ? 0
                    : self.focusIndex;
              }
              if (!self.down) {
      ...
      self.$dropDown.on("scroll.easyDropDown", function (e) {
        if (
          self.$dropDown[0].scrollTop >=
          self.$dropDown[0].scrollHeight - self.maxHeight
        ) {
    ...
    scrollToView: function () {
      ...
      if (self.focusIndex >= self.cutOff) {
        var $focusItem = self.$items.eq(self.focusIndex),
          scroll =
            $focusItem.outerHeight() * (self.focusIndex + 1) - self.maxHeight;
